...
def search_knowledge_base(query: str, tool_context: ToolContext) -> Dict[str, Any]:
    ...
    # Simple keyword matching (case-sensitive)
    ...
    for key, content in knowledge_base.items():
        ...
        if results:
            return {
                'status': 'success',
                'report': f'Found {len(results)} relevant articles for "{query}"',
                'results': results
                }
            ...
            return {
                'status': 'success',
                'report': f'No relevant articles found for "{query}"',
                'results': []
            }
...
def ticket_status(ticket_id: str, tool_context: ToolContext) -> Dict[str, Any]:
    """
